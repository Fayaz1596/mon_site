...
<html lang="fr">
    ...
    <body>
            ...
            <div class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content">
                    <div class="dropdown-before">
                        ...
                        <a href="#taches" class="menu" id="m-tac">Tâches</a>
        ...
        <main>
            ...
            <!-- Tâches -->
            <section id="taches" class="homeslide" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -200px;" data-bottom-top="background-position: 50% 200px;">
                        ...
                        <div class="todo-list" data-liste-contenu>
                            <div>
                                <div class="todo-header">
                                    <h3 class="list-title" data-liste-titre>Nouveau titre</h3> 
                                    <h4 class="list-subtitle" data-liste-sous-titre>Nouveau sous-titre</h4>
                                </div>
                                <div class="todo-body">
